...
public class InviteEventsViewModel extends ViewModel {
    ...
    private void loadEvents() {
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                httpRequest.addParam("filter", "inviteevents");
    ...
    static public class InviteEventsViewModelFactory implements ViewModelProvider.Factory {

        Context context;

        public InviteEventsViewModelFactory(Context context) {
            this.context = context;
        }
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            ...
            return (T) new InviteEventsViewModel(context);
        }
    }
